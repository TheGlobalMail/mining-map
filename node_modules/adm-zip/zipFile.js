...
module.exports = function(/*Buffer*/buf) {
    ...
    return {
        ...
        fixEntry : function(entryName, newEntryName){
            var entry = entryTable[entryName];
            if (entry.entryName.match(/shp/)){
            ...
            this.setEntry(entry);
            console.error("Fixed:");
            console.error(entryTable[newEntryName].entryName);
            if (entry.entryName.match(/shp/)){
                console.error(entryTable[newEntryName]);
            }
        },
        ...
        toBuffer : function() {
            ...
            entryList.forEach(function(entry) {
                ...
                console.error("getting compressed data: " + compressedData.length);
